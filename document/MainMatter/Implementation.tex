...
Para la solución propuesta se implementó un servidor usando \textit{FastApi}, un \textit{framework} que permite crear aplicaciones web de forma sencilla y rápida usando \textit{Python}.
...
Como se mencionó anteriormente, el servidor principal de la aplicación está desarrollado en \textit{Python} utilizando el \textit{framework} \textit{FastApi}.
...
Como parte de la solución se desarrolló una interfaz gráfica web utilizando el \textit{framework} \textit{Next.js}.
