...
\begin{itemize}
  ...
  \item \textbf{Restricciones especiales:} Algunas restricciones presentan una formulación un poco más compleja, ya que no entran en las clasificaciones clásicas como lineales o no lineales (ej: todas las variables deben ser diferentes, o deben haber al menos n variables con valor k, etc). Estas restricciones especiales se modelan en este campo.
