...
\advisor{\\\vspace{0.25cm}Suilan Estévez Velarde\\\vspace{0.2cm}Deborah Famadas Rodríguez}
\degree{Licenciado en Ciencia de la Computación}
\faculty{Facultad de Matemática y Computación}
\date{Fecha\\\vspace{0.25cm}\href{https://github.com/karlosgr/nlopt}{https://github.com/karlosgr/nlopt}}
